...
const teslaInfo = <p>Group project with 3 other members in which we recreated the Tesla shop page. A set of product data was recreated for the products page, and the project involved working in a team on Github. </p>
